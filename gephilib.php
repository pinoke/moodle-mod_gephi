<?php
function gephi_show_course_dots($course)
{
	global $DB;
...
function gephi_show_dot_name($arr)
{
	global $DB;
	$arrs=array();
...
function gephi_show_course_name_dots($course)
{
	global $DB;
	$arr=array();
...
function gephi_show_username($arrs)
{
	global $DB;
	$names=array();
	 foreach ($arrs as $id)
